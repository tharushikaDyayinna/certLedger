...
def generate_certificate(output_path, uid, candidate_name, course_name, org_name, institute_logo_path):
    ...
    elements.extend([title1, Spacer(2, 6)])
    ...
    recipient_text = f"This is to certify that<br/><br/>\
                     <font color='black' size='10'> {candidate_name} </font><br/>\
                     with UID <br/> \
                    <font color='black' size='10'> {uid} </font> <br/><br/>\
                     has successfully completed the course:<br/>\
                     <font color='black' size='10'> {course_name} </font>"
